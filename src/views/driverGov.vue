<template>
  <div class="data-container">
    <div class="header">
      <router-link to="/management" class="back-button">
...
export default {
  ...
  try {
    ...
    const blockUrl = `${this.apiUrl}/dashboard/block/${driver.id}`;
    console.log("Block URL:", blockUrl);

    const response = await fetch(blockUrl, {
      method: "POST", // atau PUT jika endpoint-nya tidak menerima POST
      headers,
    });
