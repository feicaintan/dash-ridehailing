      ...
      <transition-group name="fade" tag="div" class="driver-grid">
        ...
        >
          ...
          <div class="action-buttons">
            <button @click="previewKTP(driver)" class="preview-button">
              Lihat KTP
            </button>
            <button @click="acceptDriver(driver)" class="accept-button">
              <span class="button-icon">✓</span> Terima
            </button>
          </div>
        </div>
      </transition-group>
...
import { useDriverStore } from '@/stores/driverStore'; // import store
